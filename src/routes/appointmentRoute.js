...
const updateAppointmentById = require("../controllers/appointment/updateAppointmentById");
...
router.patch("/:id", auth, access(["DOCTOR", "RECEPTIONIST"]), updateAppointmentById);
